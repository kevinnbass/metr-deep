<!-- casework-lane {"claim_id":"C06","elements":["C06.E1","C06.E2"],"materializer":2,"outputs":["research/grok-out/MD17-rand-canary-receipts.csv"],"pack":"metr_deep","plan_lane":"MD17","plan_sha256":"7ff1e5a3d68d5eadfdb76c0ff002060e21ce4adbff1fa3c5c6ef52d5cad0f9e2"} -->

# MD17 — RAND-side Canary receipts and directed grants
...
Scope: RAND-side Canary receipts and directed grants.
Primary routes: RAND reports, funding pages and Forms 990; funder filings.
...
Row typing: put the target table prefix in target_prefix on every row (MDE entity, MDF funding event, MDI in-kind or access, MDP provenance proposition, MDQ project conflict, MDR relationship, MDS source coverage and bounded negative, MDT timeline event) and put the case element ids this row would support in element_ids, semicolon separated, from: C06.E1, C06.E2. Leave any column that does not apply to a row empty rather than guessing.

Task A — Record every RAND disclosure naming Canary or the centre that houses it: funder names, amounts, terms and the dated document.
Task B — Find filed payments to RAND from Audacious partners and other named funders in grantor filings, with amount, fiscal year, purpose text and filing object id.
Task C — Record RAND's own Form 990 lines that could carry the Canary money and the years checked.
Task D — State explicitly for each RAND receipt that a payment to RAND is not a payment to METR, and record whether any document shows onward passage.
