<!-- casework-lane {"claim_id":"C02","elements":["C02.E2"],"materializer":2,"outputs":["research/grok-out/MD05-sijbrandij-foundation.csv"],"pack":"metr_deep","plan_lane":"MD05","plan_sha256":"7ff1e5a3d68d5eadfdb76c0ff002060e21ce4adbff1fa3c5c6ef52d5cad0f9e2"} -->

# MD05 — Sijbrandij Foundation
...
Scope: Sijbrandij Foundation.
Primary routes: Sijbrandij Foundation site and grant listings; Form 990-PF; state registry.
...
Task A — Record every Sijbrandij Foundation grant, commitment or pledge naming METR, with amount, date, duration, restriction and the document that states it.
Task B — Recover the foundation's Forms 990-PF for the years that could carry a METR line and record the Part XV entries, distinguishing paid grants from amounts approved for future payment.
Task C — Record the foundation's legal name, EIN, state registration and any related vehicle or donor-advised account named in its own materials, keeping each entity separate.
Task D — Record the grant purpose and any restriction verbatim, and whether the amount falls inside METR's stated February to August 2026 commitment window.
...
Output `research/grok-out/MD05-sijbrandij-foundation.csv` with columns: `row,task,target_prefix,element_ids,subject,entity_type,aliases,identifier,from_entity,intermediary,to_entity,relationship_type,start_date,end_date,ledger,money_type,amount_usd,currency,date,date_precision,period,payment_status,purpose_restriction,project,provider,in_kind_type,quantity_or_value,terms,policy_version,disclosure_recusal,provider_authority,personnel_conflicts,edge_type,documented_transaction,source_class,query_or_endpoint,url,quote_300,checked_utc,result,result_count,next_document,limitation,note`.

Standard goal:

```text
/goal Run research/grok-briefs/MD05-sijbrandij-foundation.md exactly as written; write only research/grok-out/MD05-sijbrandij-foundation.csv and research/primary/MD05-sijbrandij-foundation/
```
